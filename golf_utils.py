...
class MyDataset(Dataset):
    ...
    def __init__(self, args, path, dataset=None, load_content=True):
        if load_content:
            self.content = self.load_dataset(args, path)
        elif not load_content and dataset is not None:
        ...
        self.arg1_mask, self.arg2_mask = self._to_tensor(self.content)
